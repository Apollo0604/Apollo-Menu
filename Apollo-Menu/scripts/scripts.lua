...
AddEventHandler('displaytweet',function(inputText)
    ...
    SetNotificationMessage("CHAR_FLOYD", "TWEET", true, 1, "Tweet", "~n~~b~ID:~w~"..id );
...
AddEventHandler('displaytowrequest',function(inputText)
    ...
    SetNotificationTextEntry("STRING");
    AddTextComponentString(inputText);
    SetNotificationMessage("CHAR_FLOYD", "TOW", true, 1, "~b~Tow Request~w~", "~n~~b~ID:~w~"..id );
	DrawNotification(false, true);
...
AddEventHandler("meth", function()
	...
	Citizen.Wait(16000)
	ClearPedTasksImmediately(GetPlayerPed(-1))
	SetTimecycleModifier("ArenaWheelPurple01")
	RequestAnimSet("move_f@scared") 
    HasAnimSetLoaded("move_f@scared")	
	SetPedMovementClipset(ped, "move_f@scared", 1)
	SetTimeScale(0.6 )
	DisplayNotification("Meth is one hell of a drug!")
	Citizen.Wait(17500)
end)
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "247", true, 1, "247", "~n~~b~ID:~w~"..id );
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_AMMUNATION", "CHAR_AMMUNATION", true, 1, "~y~Ammunation~s~", "ID:~b~" .. id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "NEWS", true, 1, "~y~Weazel News~s~", "ID:~b~" .. id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_MP_STRIPCLUB_PR", "CHAR_MP_STRIPCLUB_PR", true, 1, "~y~Vanilla Unicorn~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_TAXI", "CHAR_TAXI", true, 1, "~y~Downtown Cab Co.~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_LS_TOURIST_BOARD", "CHAR_LS_TOURIST_BOARD", true, 1, "~y~Los Santos Traffic Info~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_LS_CUSTOMS", "CHAR_LS_CUSTOMS", true, 1, "~y~Los Santos Customs~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "ACE", true, 1, "~y~Liquor Ace~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "LTD", true, 1, "~y~Limited Gasoline~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "POSTAL", true, 1, "~y~GoPostal~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "TOW", true, 1, "~r~Mike Towing~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "VAN", true, 1, "~r~Black Market~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "BELL", true, 1, "~y~Cluckin' Bell~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "BUG", true, 1, "~y~Bugstars~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_BANK_FLEECA", "CHAR_BANK_FLEECA", true, 1, "~y~Fleeca Bank~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "NA", true, 1, "~y~Echo Sechs~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_MP_MORS_MUTUAL", "CHAR_MP_MORS_MUTUAL", true, 1, "~y~Mors Mutual Insurance~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "OP", true, 1, "~y~PostOP~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "EXOTIC", true, 1, "~y~Auto Exotic~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText); 
SetNotificationMessage("CHAR_FLOYD", "LSWP", true, 1, "~y~Los Santos Water and Power~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
--
--
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "D8", true, 1, "~y~Dynasty 8~s~", "ID:~b~" ..id);
DrawNotification(false, true);
end)
-- Apollo©